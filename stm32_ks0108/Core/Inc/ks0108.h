...
#define sbi(gpio_port,gpio_pin) HAL_GPIO_WritePin(gpio_port, gpio_pin, GPIO_PIN_SET)
#define cbi(gpio_port,gpio_pin) HAL_GPIO_WritePin(gpio_port, gpio_pin, GPIO_PIN_RESET)
#define outb(gpio_port,gpio_data) LL_GPIO_WriteOutputPort(gpio_port, ((LL_GPIO_ReadOutputPort(gpio_port) & 0xFF00) | gpio_data))
#define inb(gpio_port) (LL_GPIO_ReadOutputPort(gpio_port) & 0xFF)
